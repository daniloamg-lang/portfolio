  ...
  en: {
    translation: {
      ...
      skills: {
        ...
        aria: 'Skills list',
        items: [
          'Agile product leadership and Scrum implementation',
          'UX strategy and scalable design systems',
          'AI agents for operational and development efficiency',
          'B2B SaaS strategy and high-level client negotiation',
          'Cross-functional alignment with frontend and backend teams',
  ...
  es: {
    translation: {
      ...
      skills: {
        ...
        items: [
          'Liderazgo de producto e implementación Agile/Scrum',
          'Estrategia UX y sistemas de diseño escalables',
          'Implementación de agentes IA para eficiencia operativa y de desarrollo',
          'Estrategia B2B SaaS y negociación con clientes de alto nivel',
          'Alineación cross-funcional con equipos frontend y backend',
